...
amp_thres=1500;
angle_delta=0.2;
dist_delta=20;     % distance delta to distingush different reflectors
thres_dist_match=10;
...
[mode,status,update_match_pool]=mode_manager(interrupt,scan_freq,reflector_source_flag,req_update_match_pool,num_ref_pool,num_detect_pool,scan_data,amp_thres,angle_delta,dist_delta,thres_dist_match,thres_dist_large);
